...
| `nest-controller-returns-dto` | `allowFilePatterns` (globs), `controllerDecoratorNames`, `dtoLayerSource`, `gatewayDecoratorNames`, `responseHandlerParamDecorators`, `streamReturnTypes`, `allowPrimitiveReturns` |
