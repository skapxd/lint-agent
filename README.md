...
La skill esta indexada en skills.sh, invoca el CLI publicado `@skapxd/eslint-opinionated@6` con npm provenance y no modifica el proyecto medido: la evaluacion es efimera y solo lectura salvo que pidas aplicar fixes.
...
| [`skapxd/no-exported-function-bag`](https://github.com/skapxd/eslint-opinionated/blob/main/docs/reglas/no-exported-function-bag.md) | Prohíbe exportar objetos que publican varias funciones: una bolsa de funciones es una clase o namespace disfrazado. |
