...
La skill esta indexada en skills.sh, invoca el CLI publicado `@skapxd/eslint-opinionated@4` con npm provenance y no modifica el proyecto medido: la evaluacion es efimera y solo lectura salvo que pidas aplicar fixes.
