...
| [`skapxd/nest-controller-returns-dto`](https://github.com/skapxd/eslint-opinionated/blob/main/docs/reglas/nest-controller-returns-dto.md) | Los métodos de ruta de un `@Controller` declaran un DTO explícito como retorno para que Swagger genere el response schema. Preset `nest`. |
