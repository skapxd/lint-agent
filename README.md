...
| [`skapxd/no-flat-dump-folder`](https://github.com/skapxd/eslint-opinionated/blob/main/docs/reglas/no-flat-dump-folder.md) | Evita que carpetas cajón de sastre como `utils/` o `helpers/` acumulen archivos sueltos; cada util vive en un subdominio. |
